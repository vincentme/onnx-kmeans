...
def plot_clusters(X, y, centroids_mojo, centroids_python, centroids_onnx, centroids_actual):
    ...
    centroids_onnx_pca = pca.transform(centroids_onnx)
    ...
    plt.scatter(np.take(centroids_onnx_pca, 0, axis=1), np.take(centroids_onnx_pca, 1, axis=1), marker='+', color='black', facecolors='black', s=100, label='ONNX centroids')
